...
export default function RelMention(props){
    const { view,concepts,inarel,relationship,document_id,showrelspannel,modifyrel,predicate,source,target,currentdiv,firstsel,curmention,secondsel,collection,mentions,addconceptmodal,mentiontohighlight,startrange,endrange } = useContext(AppContext);
    ...
    const [ModifyRel,SetModifyRel] = modifyrel
    let key = props.loc
    ...
    //     if(ShowRels && (ModifyRel || ShowReadOnlyRelation) && Source && mentions.indexOf(Source) !== -1){
    //         changeRole('Source')
    //     }
    // },[Source])
    //
    ...
    //     let mentions = props.mention.mentions.split(' ')
    //
    //     if(ShowRels && (ModifyRel || ShowReadOnlyRelation) && Predicate && mentions.indexOf(Predicate) !== -1){
    ...
    //     let mentions = props.mention.mentions.split(' ')
    //
    //     if(ShowRels && Target && (ModifyRel || ShowReadOnlyRelation)&& mentions.indexOf(Target) !== -1){
    //         changeRole('Target')
    //     }
    // },[Target])
    ...
    //
    //     waitForElm('#'+props.id).then((mention) => {
    //         if(Predicate !== props.mention.mentions){
    //             updateClassesStandard(mention)
    //
    //         }
    //         mention.style.color = color_0
    ...
    //
    //     waitForElm('#'+props.id).then((mention) => {
    //         if(Target !== props.mention.mentions){
    //             updateClassesStandard(mention)
    //
    //         }
    //         mention.style.color = color_0
    ...
    return (
        <div className={'mentionpart_rel'}>
            ...
            {<div  onContextMenu={handleContextMenu} >
                ...
                {ShowReadOnlyRelation === false && <StyledMenu
