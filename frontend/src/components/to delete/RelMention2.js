...
import {RelationshipContext} from "../../BaseIndex";

export default function RelMention(props){
    const { view,concepts,inarel,document_id,areascolors,currentdiv,firstsel,curmention,secondsel,collection,mentions,addconceptmodal,mentiontohighlight,startrange,endrange } = useContext(AppContext);
    ...
    const { predicate,source,target,sparrow,ptarrow,starrow,targetconcepts,predicatetext,predicateconcepts } = useContext(RelationshipContext);
