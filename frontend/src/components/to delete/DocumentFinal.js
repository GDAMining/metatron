...
export default function Document(props){
    ...
    const [LoadingDocDesc,SetLoadingDocDesc] = useState(false)
    ...
    return(
        <div>
            {isPending ? <div>ciao</div> : <div>ahah</div>}
            {/*{(LoadingDoc || !MentionsList || !FieldsToAnn  )? <div className='loading'>*/}
            {/*    <CircularProgress />*/}
            {/*</div> : <div className='paper_doc' id='paper_doc' onClick={(e)=>ClickOutsideWord(e)}>*/}
            ...
            {/*                    {obj['type'].startsWith('no_') ? <span className='no_mention' id = {mention_key+'_'+i.toString()}>{obj['text']}</span> : <div style={{display:'inline-block'}}><Mention id = {mention_key+'_'+i.toString()} start = {obj['start']} stop= {obj['stop']}  class = {obj['mentions']} loc = {mention_key} mention={obj} mention_text = {obj['text']}  /></div>}*/}
            {/*                </>)}</h3>*/}
            ...
            {/*                                    <Mention id = {mention_key+'_'+i.toString()} start = {obj['start']} stop= {obj['stop']} loc = {mention_key} class = {obj['mentions']} mention_text = {obj['text']} mention={obj}  />*/}
            {/*                                </div>}*/}
            ...
            {/*                                        {obj['type'].startsWith('no_') ? <span className='no_mention' id = {mention_key+'_'+i.toString()}>{obj['text']}</span> : <div style={{display:'inline-block'}}><Mention id = {mention_key+'_'+i.toString()} start = {obj['start']} stop= {obj['stop']} loc = {mention_key} class = {obj['mentions']} mention_text = {obj['text']} mention={obj} /></div>}*/}
